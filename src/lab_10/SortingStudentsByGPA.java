...
public class SortingStudentsByGPA {
    ...
    public static void main(String[] args) {
        ...
        students_2[0] = new Student("Tuan", "Mai", "Game",2,"ИКБО-33-21",2);
        students_2[1] = new Student("Vinh", "Pham", "Web",2,"ИКБО-30-21",1);
        students_2[2] = new Student("Vinh", "Nghiem", "AI",2,"ИКБО-04-21",0);
