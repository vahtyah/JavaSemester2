...
public class TestShape {
    public static void main(String[] args) {
       ...
       //System.out.println(s1.getRadius()); //shape
       ...
       // System.out.println(s3.getLength()); //shape
        ...
        //System.out.println(s4.getSide()); //shape
       ...
       //System.out.println(r2.getSide()); //rectangle
